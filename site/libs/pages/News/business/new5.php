        ...
        <div class="container-fluid">
            <div class="container shadow pt-3 pb-3 mt-3 mb-3">
                <div class="bg-secondary text-white pt-2 pb-2">
                    <p class="font-weight-bold text-center align-middle display-4">Comissão mista da covid-19 debate na terça dificuldades de microempresas<p>
                </div>
                <div class="container">
                    <div class="container pt-3 pb-3">
                        <div class="container mb-3">
                            <img src="../../../images/news/imagem_materia2.jpg" class="rounded mx-auto d-block img-fluid" alt="Saúde Logo" id="logo">
                        </div>
                        <div class="container">
                            <div class="row h-75 text-justify">
                                <div id="textoMateria">
                                    ...
                                    <p>Os senadores e convidados querem discutir também a falta de previsão orçamentária direcionada a políticas públicas de crédito para os pequenos negócios no Orçamento de 2021.</p>
                                    <p>Para participar da audiência estão confirmados:</p>
                                    <p>— Ercílio Santinon, presidente da Confederação Nacional das Micro e Pequenas Empresas e Empreendedores Individuais (Conampe);</p>
                                    <p>— Rosi Dedekind, presidente da Federação das Associações de Micro e Pequenas Empresas e dos empreendedores Individuais de Santa Catarina (Fampesc),</p>
                                    <p>— Adael dos Santos, presidente da Associação de Joinville e Região de Pequenas, Micro e Médias Empresas (Ajorpeme),</p>
                                    <p>— Cláudia Cisneiros, presidente da Associação Brasileira das Organizações de Microcrédito e Finanças (ABCRED),</p>
                                    <p>— Kedson Macedo, presidente da Confederação Brasileira das Cooperativas de Crédito (Confebras),</p>
                                    <p>— Silas Santiago, gerente de Políticas Públicas do Sebrae Nacional</p>
                                    <p>— Bruno Laskowsky, diretor do Departamento de Conformidade e Prevenção a Fraudes do BNDES.</p>
                                    <p>— Luciano Quinto Lanz. chefe do Departamento de Conformidade e Prevenção a Fraudes do BNDES.</p>
                                    <p>— Celso Leonardo Barbosa, vice-presidente de Negócios e Varejos da Caixa Econômica Federal.</p>
                                </div>
                            </div>
                        </div>
                    </div>
