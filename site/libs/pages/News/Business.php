...
<head>
    <title>Notícias - Finanças Empresariais</title>
    <!-- Required meta tags -->
    <meta charset="UTF-8">
                    ...
                    <div class="container w-100 mx-auto mb-2 pt-1">
                        <div class="row">
                            <div class="btn-group border rounded-lg mr-5">
                                ...
                                <a href="Business.php"><button class="btn btn-light active">Finanças Empresariais</button></a><span class="border border-top-0 border-left-0 border-bottom-0"></span>
