...
<head>
    <title>Estatísticas - Cidades</title>
    <!-- Required meta tags -->
    <meta charset="UTF-8">
        ...
        <div class="container-fluid">
            <div class="container shadow pt-3 pb-3 mt-3 mb-3">
                <div class="bg-secondary text-white pt-2 pb-2">
                    <p class="font-weight-bold text-center align-middle display-4">Cidades<p>
                </div>
                <div class="container mt-2 mb-4">
                    <form action="" method="get">
                        <div class="form-inline justify-content-end">
                            <input type="text" class="form-control mr-2" name="state" id="state" placeholder="Digite um estado">
                            <input type="text" class="form-control mr-2" name="city" id="city" placeholder="Digite uma cidade">
